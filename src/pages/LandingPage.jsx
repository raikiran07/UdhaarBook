    ...
    <div className='landing w-full h-[100vh] relative'>
     ...
     <h2 className='text-white text-center mt-24 text-2xl curveUnderlined mb-8'>Features and Process</h2>
        ...
        <div className='flex flex-col items-center justify-center gap-4 max-w-[60%] mx-auto mt-4 ease-linear md:flex-row'>
            <div className=' text-gray-800 border p-2 bg-gray-300 rounded-md min-h-[260px] flex-1 hover:scale-150 duration-100 ease-linear'>
            ...
            <div className='card text-white border p-2 rounded-md hover:bg-gray-300 hover:text-gray-800 min-h-[260px] flex-1 hover:scale-150 duration-100 ease-linear'>
